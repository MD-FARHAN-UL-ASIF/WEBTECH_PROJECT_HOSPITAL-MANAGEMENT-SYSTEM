...
include('../control/update-appointAction.php');
?>
...
<title>Appointment Mangement</title>
<style>
...
<input type="text" placeholder="Enter Doctor Name" name="d_name" required value="<?php echo isset($editData) ? $editData['d_name'] : '' ?>">
