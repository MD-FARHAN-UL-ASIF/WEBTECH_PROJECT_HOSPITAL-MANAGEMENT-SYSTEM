...
include('../control/read-bloodAction.php');
?>
...
<td><?php echo $data['blood_status']; ?></td>
<td><?php echo $data['exp_date']; ?></td>
<td><?php echo $data['source_type']; ?></td>

<td><a style="text-decoration:none;" href="../view/update-blood.php?edit=<?php echo $data['id']; ?>">
...
<td><a style="text-decoration:none;" href="../control/delete-bloodAction.php?delete=<?php echo $data['id']; ?>">
...
?>
    ...
    <button type="create" onclick="document.location='../view/create-blood.php'">Add a new blood..!</button>
