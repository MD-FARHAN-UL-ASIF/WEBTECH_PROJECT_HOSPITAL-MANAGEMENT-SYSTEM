...
include('../control/read-appointAction.php');
?>
...
<td><a style="text-decoration:none;" href="../view/update-appoint.php?edit=<?php echo $data['id']; ?>">
...
<td><a style="text-decoration:none;" href="../control/delete-appointAction.php?delete=<?php echo $data['id']; ?>">
...
?>
    ...
    <button type="create" onclick="document.location='../view/create-appoint.php'">Create a new appointment..!</button>
